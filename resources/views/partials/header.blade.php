    ...
    <div class="container pb-5 border-bottom">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="navbar-nav d-flex align-items-center justify-content-end">
                ...
                <div class="">
                    <div class="">
                        <a href="" class="mr-4 font-size-16 text-dark">ДОСТАВКА</a>
                        <a href="" class="font-size-16 text-dark">ПОМОЩЬ/КОНТАКТЫ</a>
                    </div>
                    <div class="mt-2 d-flex align-items-center">
                        <div class="position-relative">
                            <div class="position-absolute search-content bg-white border rounded" style="right:0%; top: 100%; z-index: 99999; width:300px; max-height:200px; overflow-y: auto;">
                            </div>
                        ...
                        </div><img class="ml-3" src="{{ asset('images/cart.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
